...
$_SESSION['statusType'] = "watchOccupancy";
    ...
    <div class="main-body">
        ...
        <table class="tableE">
            <thead class="tableE-head">
                <tr>
                    <th class="column" colspan="100%">
                        ...
                        echo $chosenDate . ' / Аудитория ' . $record['roomName'] . ' / С ' . $startHour . ':00 до ' . $endHour . ':00';
                        ?>
                    </th>
                </tr>
            </thead>
            ...
            <tbody class="tableE-body">
                <?php
                $query = "SELECT requestID FROM bookingrecords WHERE bookingDate = '$chosenDate' AND roomID = $roomID AND startHour = $startHour LIMIT $offSet,$perPage";
