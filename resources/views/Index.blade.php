        ...
        <div class="thirdDiv">
            ...
            <div class="help">
                ...
                <ol>
                    ...
                    <li>Нажмите на сайте <b>Статус заявки</b> и укажите номер заявки и почту, указанную в заявке.
                    </li>
                    <li>Вам будет сообщён статус заявки.</li>
                    <li>Если заявка одобрена, выберите удобный для вас день пересдачи (доступные дни для пересдачи
                        выделены зелёным).</li>
                    <li>После выберите удобное для вас время и аудиторию (Если пересдача онлайн, то выбрать нужно
                        только день).</li>
                    <li>Готово!</li>
                </ol>
                <br>
